...
class blk(gr.sync_block):
    def __init__(self, FileName='None', Pkt_len=52, encryption_key=0x55):
        ...
        self.char_list = [37, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 93]
    ...
    def work(self, input_items, output_items):
        if self.state == 0:
            ...
            while not self._eof:
                ...
                # XOR encryption for file data
                encrypted_data = bytes([byte ^ self.encryption_key for byte in buff])
            ...
            j = 0
            while i < (fn_len + 8):
                # XOR encryption for file name
                output_items[0][i] = ord(self.FileName[j]) ^ self.encryption_key
                i += 1
                j += 1
            self.state = 4
            return fn_len + 8
            ...
            i = 0
            while i < self.f_len:
                # XOR encryption for post filler
                output_items[0][i] = self.filler[i] ^ self.encryption_key
                i += 1
            self.pre_count += 1
