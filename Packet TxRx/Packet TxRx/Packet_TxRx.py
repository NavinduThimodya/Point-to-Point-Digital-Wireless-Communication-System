...
import Packet_TxRx_epy_block_0 as epy_block_0  # embedded python block
import Packet_TxRx_epy_block_0_0_0_0_0_0_0_0 as epy_block_0_0_0_0_0_0_0_0  # embedded python block
import Packet_TxRx_epy_block_1 as epy_block_1  # embedded python block
import sip



class Packet_TxRx(gr.top_block, Qt.QWidget):

    def __init__(self, MTU=1500, frame_size=30, puncpat='11'):
        gr.top_block.__init__(self, "Packet_TxRx", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Packet_TxRx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Packet_TxRx")
        ...
        self.samp_rate_0 = samp_rate_0 = 50000
        ...
        self.file_name = file_name = '/home/dinuka/Downloads/Packet TxRx(1)/Packet TxRx/image.jpeg'
        ...
        self.epy_block_1 = epy_block_1.SimpleXORCrypt(xor_key=XOR_Key)
        self.epy_block_0_0_0_0_0_0_0_0 = epy_block_0_0_0_0_0_0_0_0.blk(FileName=file_name, Pkt_len=15)
        self.epy_block_0 = epy_block_0.SimpleXOREncrypt(xor_key=XOR_Key)
        ...
        self.connect((self.epy_block_0_0_0_0_0_0_0_0, 0), (self.epy_block_0, 0))
    ...
    def set_file_name(self, file_name):
        ...
        self.epy_block_0_0_0_0_0_0_0_0.FileName = self.file_name
    ...
    def set_XOR_Key(self, XOR_Key):
        self.XOR_Key = XOR_Key
        self.epy_block_0.xor_key = self.XOR_Key
        self.epy_block_1.xor_key = self.XOR_Key
...
def main(top_block_cls=Packet_TxRx, options=None):
    if options is None:
